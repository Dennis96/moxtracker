...
Dal `main` verificato `c007802d4aa63b0feeb4010e503bccf63d745c31`, il branch `codex/cloudflare-web-analytics-2026-09-26` prepara Web Analytics nel commit prodotto `d6b7c3c8e0304dbbb650cad84a1706ce273f59f8` e nel fix CSP `4d117bc49571b334b74e3190c4d7a8c5d52e2432`. La CSP consente i soli host ufficiali osservati: `static.cloudflareinsights.com` per lo script e `cloudflareinsights.com` per l'endpoint RUM usato dalla preview. Privacy IT/EN aggiornata; nessuno snippet o tracking custom. Web Analytics del progetto Pages `moxtracker` è **abilitato** tramite il dashboard.

Il deployment di verifica `99c2d97f` (build `8f9d4c0c1ca74975`) su `https://preview.moxtracker.pages.dev` espone il beacon automatico e il browser osserva la richiesta XHR a `https://cloudflareinsights.com/cdn-cgi/rum`, senza errori console/CSP. Smoke sito/API 14/14; Home, Privacy e Download IT/EN rispondono 200, con canonical di produzione, `noindex` e social card disponibili. Al momento della QA, il dashboard Web Analytics mostra ancora «Nessun dato»: la comparsa dei conteggi aggregati resta da ricontrollare dopo la normale elaborazione. Visits, Page Views e provenienze descrivono traffico web, non utenti unici o installazioni MOX. Nessun merge, deploy Pages production, Worker o migrazione D1; `moxtracker.app` non è stato aggiornato in questo delta.
...
La produzione resta **bloccata**: manca l'identità esatta del titolare del trattamento; manca almeno lo spot check su telefono fisico; il client finale deve ancora superare review indipendente/release gate. Su questa postazione non erano disponibili Chrome, Edge o Firefox e il browser integrato non esponeva l'emulazione live di reduced motion: questi limiti sono dichiarati, non convertiti in PASS. Il release script rifiuta comunque la produzione finché il segnaposto legale è presente. Nessun deploy Pages production, Worker, D1, versione client o feature flag è stato eseguito.
